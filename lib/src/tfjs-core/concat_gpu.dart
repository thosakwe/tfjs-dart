@JS()
library tfjs.node_modules._tensorflow.tfjs_core.dist.kernels.webgl.concat_gpu;

import "package:js/js.dart";
import "gpgpu_math.dart" show GPGPUProgram;

@JS()
class ConcatProgram implements GPGPUProgram {
  // @Ignore
  ConcatProgram.fakeConstructor$();
  ...
  external factory ConcatProgram(List<num> /*Tuple of <num,num>*/ aShape,
