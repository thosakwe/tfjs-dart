@JS()
library tfjs.node_modules._tensorflow.tfjs_core.dist.kernels.backend;
...
@anonymous
@JS()
abstract class BackendTimingInfo {
  external num get kernelMs;
  external set kernelMs(num v);
  external factory BackendTimingInfo({num kernelMs});
}
...
@anonymous
@JS()
abstract class KernelBackend implements TensorStorage, BackendTimer {
  ...
  external dynamic/*=T*/ reverse/*<T extends Tensor>*/(
      dynamic/*=T*/ a, List<num> axis);
  external Tensor<Rank.R2> concat(Tensor<Rank.R2> a, Tensor<Rank.R2> b);
  external dynamic/*=T*/ neg/*<T extends Tensor>*/(dynamic/*=T*/ a);
  ...
  external dynamic/*=T*/ logicalNot/*<T extends Tensor>*/(dynamic/*=T*/ a);
  ...
  external Tensor<Rank.R4> depthwiseConv2D(
      Tensor<Rank.R4> input, Tensor<Rank.R4> filter, Conv2DInfo convInfo);
  ...
  external reshape/*<T extends Tensor, R extends enum Rank>*/(dynamic/*=T*/ x,
      [List<ShapeMap> shape]);
  external Tensor/*<R>*/();
  external dynamic/*=T*/ cast/*<T extends Tensor>*/(
