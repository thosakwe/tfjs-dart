@JS()
library tfjs.node_modules._tensorflow.tfjs_core.dist.kernels.webgl.clip_gpu;

import "package:js/js.dart";
import "gpgpu_math.dart" show GPGPUProgram;

@JS()
class ClipProgram implements GPGPUProgram {
  // @Ignore
  ClipProgram.fakeConstructor$();
  ...
  external factory ClipProgram(List<num> aShape, num min, num max);
}
